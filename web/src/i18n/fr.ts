export const fr = {
  ...
  menu: {
    ...
    constitution: {
      ...
      amended1987: 'Constitution de 1987 (Amendée)',
      amended1987Desc: 'Dernière version amendée',
      amendments: 'Amendements Constitutionnels',
      amendmentsDesc: 'Tous les amendements apportés',

      col2Title: 'Documents Historiques',
      col2Desc: 'Archives constitutionnelles',
      original1987: 'Constitution de 1987 (Originale)',
      original1987Desc: 'Version originale non amendée',
      c1805: 'Constitution de 1805',
      c1805Desc: 'Première constitution haïtienne',
      c1918: 'Constitution de 1918',
      c1918Desc: "Période de l'occupation",

      col3Title: 'Ressources Constitutionnelles',
      col3Desc: 'Outils et analyses',
      analysis: 'Analyse des Amendements',
      analysisDesc: 'Études et commentaires',
      compare: 'Comparaison des Versions',
      compareDesc: 'Évolution constitutionnelle',
      glossary: 'Glossaire Constitutionnel',
      glossaryDesc: 'Termes et définitions',
    },
